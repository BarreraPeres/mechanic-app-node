...
import { DashboardPage } from "./pages/mechanic/dashboard-page";
import { OrderServiceId } from "./pages/mechanic/order-service-id";
        ...
        <Route element={<PrivateRoute />} >
          <Route element={<Layout />} >
            ...
            <Route element={<MechanicRoute />}>
              ...
              <Route path="/dashboard/:orderServiceId" element={<OrderServiceId />} />
            </Route>
